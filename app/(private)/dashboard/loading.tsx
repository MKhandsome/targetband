  ...
  return (
    <div className="flex-1 w-full p-4 md:p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="h-32 bg-white/5 animate-pulse rounded-xl border border-white/10"></div>
        <div className="h-32 bg-white/5 animate-pulse rounded-xl border border-white/10"></div>
        <div className="h-32 bg-white/5 animate-pulse rounded-xl border border-white/10"></div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="h-[400px] bg-white/5 animate-pulse rounded-xl border border-white/10"></div>
        <div className="h-[400px] bg-white/5 animate-pulse rounded-xl border border-white/10"></div>
      </div>
    </div>
  )
