  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 flex md:hidden items-center justify-between border-b border-border/50 px-4 bg-[#171717]">
           <span className="font-bold tracking-tighter text-lg">Target<span className="text-primary">Band</span></span>
        </header>

        {/* Main Content */}
        <main className="flex-1 overflow-y-auto bg-[#0C0C0C] p-4 md:p-8 lg:p-10 relative">
